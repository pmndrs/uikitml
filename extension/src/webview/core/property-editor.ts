...
export class PropertyEditor {
  ...
  hasPendingChanges(): boolean {
    return (
      (this.component?.userData?.originalValues && Object.keys(this.component.userData.originalValues).length > 0) ||
      false
    )
  }
  ...
  getComponentId(): string {
    ...
    return this.component.userData?.id || (this.component.properties.value as any)?.id || ''
  }
